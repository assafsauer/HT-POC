# SC01-TC04: Provision a Tanzu Kubernetes Cluster Using the Tanzu Kubernetes Grid Service
...
17. In the left pane, expand the **ns01** object and select the **tkc01-mm-small** resource pool
